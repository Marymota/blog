<?php 
  if(!empty($_POST))
  {
    ...
    // Validate email
    /*  Search for the email being registered in the database 
        If the email is found, add it as $email value
        The error "That email is already in use" will be printed.
    */
    ...
    if(empty($_POST['retype_password'])) {
      $errors['retype_password'] = "Retype the password";
    }
    else
...
<html lang="en" data-bs-theme="auto">
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary text-center"> <!-- Added text-center -->
...
<main class="form-signin w-100 m-auto">
  <form method="post"> <!-- Added method POST -->
    <!-- Change Logo -->
     <a href="home">
      <img class="mb-4 rounded-circle shadow" src="<?=ROOT?>/assets/images/logo.png" alt="" width="100" height="100" style="object-fit: cover";>
    </a>
    <h1 class="h3 mb-3 fw-normal">Create account</h1>

    <!-- Added PHP alert messages -->
    <?php if (!empty($errors)):?>
    ...
    <div class="form-check text-start my-3">
      <label class="form-check-label" for="flexCheckDefault">
        <input <?=old_checked('terms')?> class="form-check-input" name="terms" type="checkbox" value="remember-me" id="flexCheckDefault">Accept terms and conditions</input>
      </label>
    </div>
    <button class="btn btn-primary w-100 py-2" type="submit">Create</button></button>
    <div class="my-2">Already have an account? <a href="<?=ROOT?>/login">Login here</a></div>
    <p class="mt-5 mb-3 text-body-secondary">&copy; <?= date("Y")?></p><!-- Added PHP date() -->
  </form>
</main>
